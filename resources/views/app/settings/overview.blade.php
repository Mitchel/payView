            ...
            <div class="col-12 col-md-6">
                <div class="app-card height-93">
                    <div class="app-card-body info">
                        ...
                        <p class="fullname">@lang('payview.settings.overview')</p>
                        <i class="far fa-ballot-check fa-fw"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-8">
                <div class="app-card">
                    <div class="app-card-header">
                        @lang('payview.settings.information')
                    </div>
                    <div class="app-card-body">
                        Hi <strong>{{ $user->firstname }}</strong>! @lang('payview.settings.text')
                    </div>
                </div>
            </div>
        </div>
