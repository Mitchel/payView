            ...
            <div class="col-12 col-md-8">
                ...
                <div class="app-card">
                    <div class="app-card-body error info">
                        <strong>Additional information for adding a transaction</strong>
                        <p>
                ...
                <form action="{{ route('app.transactions.create') }}" method="POST" class="app-card">
                    @csrf
                    ...
                    <div class="app-card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="category" name="category" placeholder="payview" autocomplete="off" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="amount" name="amount" placeholder="payview" autocomplete="off" required>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="day" name="day" value="{{ date('j') }}" placeholder="payview" autocomplete="off" required>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="year" name="year" value="{{ date('Y') }}" placeholder="payview" autocomplete="off" required>
                                    <label for="year">Year</label>
                                </div>
                            </div>

                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary">Create this transaction</button>
                            </div>
                        </div>
            ...
            <div class="col-12 col-md-4">
                <div class="app-card">
                    ...
                    <div class="app-card-body border-bottom">
                        In the form to create your transaction you will be asked for a category ID, this ID can be found in the information field below.
                    </div>
